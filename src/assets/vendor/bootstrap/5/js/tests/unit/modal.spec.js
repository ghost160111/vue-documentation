...
describe('Modal', () => {
  ...
  describe('show', () => {
    ...
    it('should not overflow when clicking outside of modal-content if backdrop = static', (done) => {
      fixtureEl.innerHTML =
        '<div class="modal"><div class="modal-dialog" style="transition-duration: 20ms;"></div></div>'
    ...
    it('should not queue multiple callbacks when clicking outside of modal-content and backdrop = static', (done) => {
      fixtureEl.innerHTML =
        '<div class="modal"><div class="modal-dialog" style="transition-duration: 50ms;"></div></div>'
    ...
    it('should enforce focus', (done) => {
      ...
      modalEl.addEventListener('shown.bs.modal', () => {
        ...
        const focusInEvent = createEvent('focusin', {
          bubbles: true
        })
  ...
  describe('jQueryInterface', () => {
    ...
    it('should create a modal with given config', () => {
      ...
      expect(Modal.prototype.constructor).not.toHaveBeenCalledWith(div, {
        keyboard: false
      })
    ...
    it('should not call show method', () => {
      fixtureEl.innerHTML =
        '<div class="modal" data-bs-show="false"><div class="modal-dialog"></div></div>'
