  ...
  return function (A) {
    ...
    ;(this.options = A || {}),
          ...
          if (this.hasAnchorJSLink(e[i])) p.push(i)
            ...
            if (e[i].hasAttribute('id')) o = e[i].getAttribute('id')
              ...
              for (
                ...
                (n = t.indexOf((c = void 0 !== n ? a + '-' + s : c))), (s += 1), -1 !== n;

              );
              ;(n = void 0), t.push(c), e[i].setAttribute('id', c), (o = c)
            }
            ;((r = document.createElement('a')).className = 'anchorjs-link ' + this.options.class),
              ...
              '' === this.options.icon &&
                ...
                'left' === this.options.placement && (r.style.lineHeight = 'inherit')),
      ...
      (this.remove = function (A) {
        for (var e, t, o = w(A), i = 0; i < o.length; i++)
          (t = o[i].querySelector('.anchorjs-link')) &&
            (-1 !== (e = this.elements.indexOf(o[i])) && this.elements.splice(e, 1),
            o[i].removeChild(t))
        return this
      }),
      ...
      (this.hasAnchorJSLink = function (A) {
        var e =
            A.firstChild && -1 < (' ' + A.firstChild.className + ' ').indexOf(' anchorjs-link '),
