...
const defaultPluginConfig = {
  external: [bsPlugins.Data, bsPlugins.Base, bsPlugins.EventHandler, bsPlugins.SelectorEngine],
  globals: {
    [bsPlugins.Data]: 'Data',
    [bsPlugins.Base]: 'Base',
...
const getConfigByPluginKey = (pluginKey) => {
  ...
  if (pluginKey === 'Toast') {
    return {
      external: [bsPlugins.Data, bsPlugins.Base, bsPlugins.EventHandler, bsPlugins.Manipulator],
      globals: {
        [bsPlugins.Data]: 'Data',
        [bsPlugins.Base]: 'Base',
        [bsPlugins.EventHandler]: 'EventHandler',
...
const utilObjects = new Set(['Util', 'Sanitizer', 'Backdrop'])

const domObjects = new Set(['Data', 'EventHandler', 'Manipulator', 'SelectorEngine'])
